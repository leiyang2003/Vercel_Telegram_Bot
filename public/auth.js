/**
 * Injects login / user state into #auth-header.
 * Uses GET /api/me and renders "Login with Google" or "user | Logout".
 */
(function () {
  ...
  function renderLoggedIn(data) {
    ...
    el.innerHTML =
      ...
      '<a href="/logout" class="auth-logout">Logout</a>';
  }
  ...
  fetch("/api/me", { credentials: "same-origin" })
    .then(function (r) { return r.json().then(function (data) {
      if (data && data.logged_in) renderLoggedIn(data);
